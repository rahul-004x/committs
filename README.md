...
*You will be prompted to choose between OpenAI, Google AI, or OpenRouter, provide your API key, and select a model.*
...
*Review the AI-generated commit message and confirm (Y/n) to commit it directly.*
